    ...
    return (
        <section className='average'>
            ...
            >
                ...
                <ReferenceArea x1={perc} x2={7} fill="#000000" fillOpacity={0.2} />
                <Line type="monotone" dataKey="sessionLength"  stroke="url(#splitColor)" strokeWidth={3} dot={false} activeDot={{r:7, stroke:'white', strokeWidth:'15', strokeOpacity:'0.3'}} />
            </LineChart>
        </section>
    )
}
